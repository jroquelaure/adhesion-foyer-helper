...
if not defined PY (
  title Adhesions - installation de Python
  echo.
  echo ============================================================
  echo   INSTALLATION EN COURS - MERCI DE PATIENTER
  echo   Telechargement puis installation de Python (1 a 2 minutes).
  ...
  echo Installation terminee. Demarrage de l'application...
